...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppTodoTodoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div  style=\"padding: 45px 0px;margin:5px 0px;background-color: #7778ce; color: yellow;\">\n    <h4 class=\"text-center\">\nTo Do List App\n    </h4>\n<!--Here, #itemTitle is local reference for textbox-->\n\n\n</div>\n<div class=\"input-group\">\n    <input type=\"text\" class=\"form-control\" placeholder=\"Add a task\" #itemTitle>\n<div class=\"input-group-addon hover-cursor\" (click)=\"onAdd(itemTitle)\">\n<i style=\"margin-left: 1rem;\" class=\"fa fa-plus-circle fa-2x\"></i>\n</div>\n</div>\n\n\n<div style=\"margin:5px 0px\">\n    <ul class=\"list-group\">\n<li class=\"list-group-item\" *ngFor=\"let item of toDoListArray\">\n    <span class=\"hover-cursor\" [class.text-success]=\"item.isChecked\" (click)=\"alterCheck(item.$key,item.isChecked)\">\n<i class=\"fa fa-lg\" [ngClass]=\"item.isChecked?'fa-check-circle-o':'fa-circle-thin'\">\n\n</i>\n    </span>\n    {{item.title}}\n<span class=\"hover-cursor text-danger pull-right\" (click)=\"onDelete(item.$key)\">\n    <i class=\"fa fa-trash-o fa-lg\"></i>\n\n</span>\n</li>\n    </ul>\n</div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _todo_todo_component__WEBPACK_IMPORTED_MODULE_8__["TodoComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_3__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].firebase), _angular_fire_database__WEBPACK_IMPORTED_MODULE_4__["AngularFireDatabaseModule"]],
      providers: [],
    ...
    var TodoService = /*#__PURE__*/function () {
      ...
      _createClass(TodoService, [{
        ...
        value: function addTitle(title) {
          if (title === "") {
            alert('Please enter a task to the list');
          } else {
            this.toDoList.push({
              title: title,
              isChecked: false
